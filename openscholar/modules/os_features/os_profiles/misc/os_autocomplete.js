...
Drupal.jsAC.prototype.hidePopup = function (keycode) {
  ...
  if (this.selected && ((keycode && keycode != 46 && keycode != 8 && keycode != 27) || !keycode)) {
    ...
    var regExp = /\(([^)]+)\)/;
    var nid = regExp.exec(this.input.value);
    $.ajax({
...
/**
 * Empty url field when type / paste data in autocomplete field and vice versa
 */
Drupal.behaviors.autoremove = {
  attach: function (ctx) {
