...
class CpSettingsForm extends ConfigFormBase {
   ...
   * CP settings manager.
   *
   * @var \Drupal\cp_settings\Annotation\CpSettingsManagerInterface
   */
  ...
  public function access(AccountInterface $account) {
    ...
    /** @var \Drupal\cp_settings\Annotation\CpSettingInterface $cp */
  ...
  protected function getEditableConfigNames() {
    $plugins = $this->getPlugins();
    $config = [];
    /** @var \Drupal\cp_settings\Annotation\CpSettingInterface $p */
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    /** @var \Drupal\cp_settings\Annotation\CpSettingInterface[] $plugins */
    $plugins = $this->getPlugins();
    foreach ($plugins as $p) {
