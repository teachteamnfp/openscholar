...
class RoboFile extends \Robo\Tasks
{
   ...
   */
    ...
    {
        return $this->taskExec('docker-compose exec --privileged php ./vendor/bin/drush site-install openscholar -vvv -y --db-url=' . static::DB_URL . ' --sites-subdir=autotest --existing-config');
    }
