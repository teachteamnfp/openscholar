...
class SampleCitations {
  ...
  public function CiteExampleOutput() {
    ...
    if(isset($csl_styles) && is_array($csl_styles)) {
      ...
      foreach($csl_styles as $style) {
        ...
        $citation_example = $this->_os_publications_build_citation_example($style->id());
   ...
   */
  public function _os_publications_build_citation_example($csl) {
    if(!isset($csl)) {
    ...
    $node_array = $this->_os_publications_get_citation_example();
    return $this->_os_publications_theme_citation(['style_name' => $style, 'node_array' => $node_array]);
  }

  /**
   * Return a pre-built node for an example citation.
   */
  public function _os_publications_get_citation_example() {
    ...
    $contributors_etall = [
      ['family' => 'Doe', 'given' => 'John', 'category' => 'primary', 'role' => 'author'],
      ['family' => 'Smith', 'given' => 'Richard', 'category' => 'primary', 'role' => 'author'],
      ['family' => 'Rodgers', 'given' => 'Edwin', 'category' => 'primary', 'role' => 'author'],
      ['family' => 'Howard', 'given' => 'Ron', 'category' => 'primary', 'role' => 'author'],
      ['family' => 'Rodgers', 'given' => 'Jill', 'category' => 'primary', 'role' => 'author'],
      ['family' => "O'Donnell", 'given' => 'Frank', 'category' => 'primary', 'role' => 'author'],
      ['family' => 'McQuiad', 'given' => 'Robert', 'category' => 'primary', 'role' => 'author'],
      ['family' => 'Smith', 'given' => 'Jane', 'category' => 'primary', 'role' => 'author'],
      ['family' => 'Ortiz', 'given' => 'Oscar', 'category' => 'primary', 'role' => 'author'],
      ['family' => 'Edwards', 'given' => 'Rebecca', 'category' => 'primary', 'role' => 'author'],
      ['family' => "O'Neil", 'given' => 'Thomas', 'category' => 'primary', 'role' => 'author'],
      ['family' => 'Smith', 'given' => 'Kathrine', 'category' => 'primary', 'role' => 'author'],
    ];
   ...
   * @return string
   */
  public function _os_publications_theme_citation($variables) {
