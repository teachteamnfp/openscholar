...
class RoboFile extends \Robo\Tasks
{
   ...
   */
    ...
    {
        return $this->taskExec('docker-compose exec --user www-data php ./vendor/bin/drush site-install openscholar -vvv -y --db-url=' . static::DB_URL . ' --sites-subdir=autotest --existing-config');
    }
