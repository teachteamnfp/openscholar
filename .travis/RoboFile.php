...
class RoboFile extends \Robo\Tasks
{
     ...
     * The database URL.
     */
    const DB_URL = 'mysql://drupal:drupal@d8cidemo_mariadb/drupal';
   ...
   */
    ...
    protected function runFunctionalTests($groups)
    {
        ...
        $tasks[] = $this->taskExecStack()
            ->exec('docker-compose exec -T php sudo ./vendor/bin/drush cim -y')
            ->exec('docker-compose exec -T php sudo ./vendor/bin/drush cr')
