 ...
 *   and allows a ConfigStorage to inherit config objects it hasn't defined itself.
 */
interface HierarchicalStorageInterface extends StorageInterface {
   ...
   *
   * @param \Drupal\Core\Config\StorageInterface storage  The storage being added to the stack
   * @param int weight  The weight of the storage. Higher weights are read from first
   */
