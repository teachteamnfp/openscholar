   ...
   */
    ...
    protected function runCheckCodingStandards()
    {
        $tasks[] = $this->taskExecStack()
            ...
            ->exec('docker-compose exec -T php ./vendor/bin/phpcs --standard=Drupal --warning-severity=0 --ignore=profiles/themes/*/css profile')
            ->exec('docker-compose exec -T php ./vendor/bin/phpcs --standard=DrupalPractice --warning-severity=0 --ignore=profiles/themes/*/css profile');
