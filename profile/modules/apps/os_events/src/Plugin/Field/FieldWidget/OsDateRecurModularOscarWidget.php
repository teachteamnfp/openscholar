...
namespace Drupal\os_events\Plugin\Field\FieldWidget;
 ...
 *
 * @FieldWidget(
 *   id = "os_events_date_recur_modular_oscar",
 *   label = @Translation("Os Events Modular: Oscar"),
 *   field_types = {
 *     "date_recur"
 *   }
 * )
 */
class OsDateRecurModularOscarWidget extends DateRecurModularWidgetBase {
  ...
  protected function getMode(DateRecurItem $item): ?string {
    ...
    elseif ('WEEKLY' === $frequency) {
      ...
      return ($interval == 1 ? static::MODE_WEEKLY :
